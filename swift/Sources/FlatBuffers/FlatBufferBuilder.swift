...
public struct FlatBufferBuilder {
  ...
  private var stringOffsetMap: [String: Offset<Any>] = [:]
  ...
  @inline(__always)
  mutating public func require(table: Offset<Any>, fields: [Int32]) {
    for field in fields {
  ...
  @inline(__always)
  mutating public func endVector(len: Int) -> Offset<Any> {
  ...
  @inline(__always)
  mutating public func createVector<T: Scalar>(_ elements: [T]) -> Offset<Any> {
  ...
  /// - Returns: ``Offset`` of the vector
  mutating public func createVector(bytes: ContiguousBytes) -> Offset<Any> {
  ...
  /// - returns: ``Offset`` of the vector
  @inline(__always)
  mutating public func createVector<T: Enum>(_ elements: [T]) -> Offset<Any> {
    createVector(elements, size: elements.count)
  }
  ...
  /// - returns: ``Offset`` of the vector
  @inline(__always)
  mutating public func createVector(ofOffsets offsets: [Offset<Any>]) -> Offset<Any> {
  ...
  mutating public func createVector(
    ofOffsets offsets: [Offset<Any>],
    len: Int) -> Offset<Any>
  {
    startVector(len, elementSize: MemoryLayout<Offset<Any>>.size)
  ...
  /// - returns: ``Offset`` of the vector
  @inline(__always)
  mutating public func createVector(ofStrings str: [String]) -> Offset<Any> {
    var offsets: [Offset<Any>] = []
    for s in str {
  ...
  mutating public func create<T: NativeStruct>(
    struct s: T, position: VOffset) -> Offset<Any>
  {
  ...
  @inline(__always)
  mutating public func create(string str: String?) -> Offset<Any> {
  ...
  /// - returns: ``Offset`` of inserted string
  @inline(__always)
  mutating public func createShared(string str: String?) -> Offset<Any> {
    guard let str = str else { return Offset() }
  ...
  ///   - position: The predefined position of the object
  @inline(__always)
  mutating public func add(offset: Offset<Any>, at position: VOffset) {
  ...
  @inline(__always)
  @discardableResult
  mutating public func push(element o: Offset<Any>) -> UOffset {
